...
public class ViewJobActivity extends AppCompatActivity {
    ...
    //get the job from the database and display it/ populate it on the ui
    public static void getTheJob() {
        ...
        try {
            ...
            lbl_total_price.setText(app.ctx.getString(R.string.total_price) + ": " + job.get_the_total_price() + "");
    ...
    public static void setTotalPrice() {
        mJobs job = app.db.mJobsDao().get_job(_job_id);
        lbl_total_price.setText(app.ctx.getString(R.string.total_price) + ": " + globals.formatCurrencyPlain(job.get_the_total_price()));
